      ...
      faceit
         ...
         .then(function () {
            new Promise(function (resolve) {
               ...
               if (!wins) wins = `${languages(interaction, 'NOTAVAILABLE')}`
               if (!longestWinStreak)
               ...
               const allPlayerStatistic = new MessageEmbed()
                  ...
                  .addFields(
                     ...
                     {
                        name: `${languages(interaction, 'STEAMNAME')}`,
                        value: `${player.steamNickname}`,
                        inline: true
                     }
                  )
                  .addFields(
                     {
                        name: `${languages(interaction, 'MATCHESPLAYED')}`,
                        value: `${matches}`,
                        inline: true
                     },
                     {
                        name: `${languages(interaction, 'WINS')}`,
                        value: `${wins}`,
                        inline: true
                     },
                     {
                  ...
                  .addFields(
                     {
                        name: `${languages(interaction, 'LONGESTWINSTREAK')}`,
                        value: `${languages(
                           interaction,
                           'WINS'
                        )}: ${longestWinStreak}`,
                     ...
                     {
                        name: `${languages(interaction, 'CURRENTWINSTREAK')}`,
                        value: `${languages(
                           interaction,
                           'WINS'
                        )}: ${currentWinStreak}`,
                     ...
                     {
                        name: `${languages(interaction, 'WINRATE')}`,
                        value: `${winRate}%`,
                        inline: true
                     }
                  )
                  .addFields(
                     ...
                     {
                        name: `${languages(interaction, 'KD')}`,
                        value: `${averageKDRatio}`,
                        inline: true
                     }
                  )
